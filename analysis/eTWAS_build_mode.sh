...
mkdir joblogs
cp -r /PredictDBPipeline/joblogs/example ./joblogs
cp -r /PredictDBPipeline/scripts ./

cp build_model.R  ./joblogs/example/build_model.R
